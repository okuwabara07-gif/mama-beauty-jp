  ...
  return (
    <html lang="ja">
      <head>
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{__html:`{"@context": "https://schema.org", "@type": "WebSite", "name": "ママ美容Lab", "description": "ママ・育児中の美容情報", "url": "https://mama-beauty-jp.vercel.app", "publisher": {"@type": "Organization", "name": "AOKAE合同会社"}}`}} />
      </head>
      <body>{children}</body>
    </html>
  )
